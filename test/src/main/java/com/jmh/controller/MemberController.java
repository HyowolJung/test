...
//	public String testData(@RequestParam("member_Name1") String member_Name1 , @RequestParam("member_Name2")String member_Name2) {
//		memberService.add(member_Name1, member_Name2);
//		return null;
//	}
